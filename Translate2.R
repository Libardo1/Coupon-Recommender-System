# Part of this script is retrived from 
# https://www.kaggle.com/anguyen/coupon-purchase-prediction/translate-everything-to-english-using-r
...
coupon_list_test = read.csv("coupon_list_test.csv", as.is=T) # Read data file to translate
names(trans)=c("jp","en_capsule") # Rename column
...
coupon_area_test = read.csv("coupon_area_test.csv", as.is=T) 
...
names(trans)=c("jp","en_pref_name"); user_list=merge(user_list,trans,by.x="PREF_NAME",by.y="jp",all.x=T)
